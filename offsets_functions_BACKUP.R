...
initialise_ecologies <- function(global_params, parcels){
  ...
  for (eco_ind in seq_len(global_params$eco_dims)){
    initial_ecology[, , eco_ind]  = initialise_ecology(global_params, parcels)
  }
  return(initial_ecology)
}
...
select_offset_index_multi <- function(offset_pool_object, offset_multiplier, development_vals_used, offset_parcel_match){
...
update_offset_object <- function(offset_pool_object, offset_multiplier, land_parcels, development_vals_used, yr, offset_parcel_match){      
  selected_offset_object = select_offset_index_multi(offset_pool_object, offset_multiplier, development_vals_used, offset_parcel_match)
...
find_developments_offsets <- function(region_ind, global_params, region_params, current_ecology, decline_rates, parcels, index_object, perform_offsets, yr){
  ...
  if (perform_offsets == TRUE){
    ...
    offset_object <- update_offset_object(offset_pool_object, region_params[[region_ind]]$offset_multiplier, parcels$land_parcels, development_object$parcel_vals_used, yr, region_params[[region_ind]]$offset_parcel_match)                  
