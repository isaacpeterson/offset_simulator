...
outs$parcel_sets_object <- group_parcel_sets(outs$model_outputs, parcels$land_parcels, global_params$time_steps, decline_rates_initial)
...
adjusted_counters = adjust_counterfactual_post_facto(cfacs, global_params, decline_rates = decline_rates_initial, parcel_indexes = 1:(parcels$land_parcel_num), parcels, current_ecology = initial_ecology)
