initialise_common_params <- function(){
  ...
  global_params$total_dev_num = 150
  ...
  global_params$ecology_size = 150 #ecology array size (square dimension) to be broken up into regions and land parcels  
  ...
  global_params$parcel_num_x = 20 #numnber of parcels in x
  global_params$parcel_num_y = 20 #numnber of parcels in x
