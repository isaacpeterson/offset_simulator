...
cfacs <- build_counterfactuals_by_parcel_multi(global_params, decline_rates_initial, 1:(parcels$land_parcel_num), land_parcels, initial_ecology, time_steps = global_params$time_steps)
...
outs$parcel_sets_object <- group_parcel_sets(outs$model_outputs, land_parcels, global_params$time_steps, decline_rates_initial)
...
outs$parcel_trajs <- find_parcel_trajectories(land_parcels, 1:(parcels$land_parcel_num), global_params$time_steps, outs$model_outputs$trajectories[[eco_ind]])

plot_single_net_regional(outs$collated_parcel_sets_object, outs$parcel_trajs, assessed_set_index = 1, global_params, cfac_parcel_trajs)
