...
max_eco_val = 100
data_folder = paste0(path.expand('~'), '/offset_data/', data_type, '/data/')

simulation_inputs_folder = write_nested_folder(paste0(path.expand('~'), '/offset_data/', data_type, '/', 'simulation_inputs/'))
