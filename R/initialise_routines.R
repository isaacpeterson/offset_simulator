...
build_modes <- function(projection_type, feature_layers_to_use, condition_class_bounds, unique_site_vals){
...
#   } else {
# 
#     background_dynamics_modes = build_modes(projection_type = feature_params$background_projection_type, 
