...
run_offset_simulation_routines <- function(simulation_data_object, scenario_ind, realisation_ind){  
  ...
  current_data_dir = write_folder(paste0(simulation_data_object$global_params$output_folder, 
                                         'scenario_', formatC(scenario_ind, simulation_data_object$global_params$integer_placeholder_width, format = "d", flag = "0"), 
                                         '/realisation_', formatC(realisation_ind, simulation_data_object$global_params$integer_placeholder_width, format = "d", flag = "0"), '/'))
  ...
  if (simulation_data_object$global_params$save_simulation_outputs == TRUE){
    saveRDS(simulation_outputs, paste0(current_data_dir, 'realisation_',
                                           formatC(realisation_ind, simulation_data_object$global_params$integer_placeholder_width, format = "d", flag = "0"),
                                           '_outputs.rds'))
  }
  
  
  file_prefix = paste0(simulation_data_object$global_params$collated_folder,
                       'collated_scenario_',  formatC(scenario_ind, simulation_data_object$global_params$integer_placeholder_width, format = "d", flag = "0"),
                       '_realisation_', formatC(realisation_ind, simulation_data_object$global_params$integer_placeholder_width, format = "d", flag = "0"))
...
save_landscape_routine <- function(simulation_data_object, current_data_dir, yr){
  ...
  for (feature_ind in seq_along(simulation_data_object$simulation_params$features_to_use_in_simulation)){
    ...
    file_prefix = paste0('feature_', formatC(simulation_data_object$simulation_params$features_to_use_in_simulation[feature_ind], simulation_data_object$global_params$integer_placeholder_width, format = "d", flag = "0"), 
                         '_yr_', formatC(yr, simulation_data_object$global_params$integer_placeholder_width, format = "d", flag = "0"))
  ...
  if (simulation_data_object$simulation_params$use_offset_metric == TRUE){
    ...
    saveRDS(current_metric_layers, paste0(current_data_dir, 'metric_layer', '_yr_', formatC(yr, simulation_data_object$global_params$integer_placeholder_width, format = "d", flag = "0"), '.rds'))
...
shift_dynamics_set <- function(site_features_to_use, current_feature_dynamics_set, feature_dynamics_modes_to_use, dynamics_type, project_by_mean, update_dynamics_by_differential,
  ...
  if (dynamics_type == 'element_scale'){
    ...
    shifted_dynamics_set = lapply(seq_along(site_features_to_use), 
                                  function(i) lapply(seq_along(site_features_to_use[[i]]),
                                                     function(j) shift_dynamics(site_features_to_use[[i]][[j]],
    ...
    shifted_dynamics_set = lapply(seq_along(site_features_to_use), 
                                  function(i) lapply(seq_along(site_features_to_use[[i]]),
                                                     function(j) shift_dynamics(mean(site_features_to_use[[i]][[j]]),
                                                                                current_feature_dynamics_to_use = current_feature_dynamics_set[[i]][[j]],
                                                                                feature_dynamics_modes_to_use[[i]][[j]],
                                                                                current_time_shift = time_shifts[[i]][[j]], 
                                                                                time_fill, 
