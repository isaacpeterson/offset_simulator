...
site_plot_lims = rep(list(c(0, 1e3)), length(plot_vec))
site_impact_plot_lims = rep(list(c(-1e4, 1e4)), length(plot_vec))

program_outcome_plot_lims = rep(list(c(0, 5e6)), length(plot_vec))
landscape_outcome_plot_lims = rep(list(c(0, 3e6)), length(plot_vec))

program_impact_plot_lims = rep(list(c(-3e5, 3e5)), length(plot_vec)) 
