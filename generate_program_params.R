...
collate_current_program <- function(current_program){
  ...
  current_program$use_dev_credit = (current_program$use_parcel_set_dev_credit) || (current_program$offset_bank_type == 'continuous_credit')
  ...
  if( (current_program$offset_calc_type == 'avoided_degredation') || (current_program$offset_calc_type == 'restoration_from_cfac') || (current_program$offset_calc_type == 'future_condition') ){
